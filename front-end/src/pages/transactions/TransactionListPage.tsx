...
const StyledAmountCell = styled.span<{ type: TransactionType }>`
  font-weight: 600;
  color: ${(props) => (props.type === TransactionType.INCOME ? '#10b981' : '#ef4444')};
`;

const TransactionTypeTag = styled(Tag)<{ type: TransactionType }>`
  background-color: ${(props) => (props.type === TransactionType.INCOME ? '#d1fae5' : '#fee2e2')};
  color: ${(props) => (props.type === TransactionType.INCOME ? '#065f46' : '#7f1d1d')};
  border: none;
`;
